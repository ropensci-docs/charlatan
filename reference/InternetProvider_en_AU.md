...
- [`InternetProvider_en_AU$clone()`](#method-InternetProvider_en_AU-clone)
...
#> Warning:  CompanyProvider does not have locale en_AU, defaulting to en_US locale.
#> Warning:  PersonProvider does not have locale en_AU, defaulting to en_US locale.
#> Warning:  LoremProvider does not have locale en_AU, defaulting to en_US locale.
x$mac_address()
#> [1] "fd:3f:c2:ef:e4:30:2e"
```
