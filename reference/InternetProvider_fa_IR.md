...
- [`InternetProvider_fa_IR$clone()`](#method-InternetProvider_fa_IR-clone)
...
#> Warning:  LoremProvider does not have locale fa_IR, defaulting to en_US locale.
x$email()
#> [1] "امیرمحمد36@ساخت.org"
x$free_email()
#> [1] "سماوات.یوسف@gmail.com"
x$mac_address()
#> [1] "ea:d5:14:54:a5:24:7a"
x$company_email()
#> [1] "جهانی.كیان@گلاب.net"
```
