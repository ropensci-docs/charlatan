...
- [`InternetProvider_de_DE$clone()`](#method-InternetProvider_de_DE-clone)
...
#> Warning:  LoremProvider does not have locale de_DE, defaulting to en_US locale.
x$email()
#> [1] "berger.samira@gmail.com"
x$free_email()
#> [1] "freudenberger.gunar@aol.de"
x$mac_address()
#> [1] "99:fd:64:3d:9c:c0:47"
x$company_email()
#> [1] "alwina.holsten@jessel.de"
```
