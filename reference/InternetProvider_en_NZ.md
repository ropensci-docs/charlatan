...
- [`InternetProvider_en_NZ$clone()`](#method-InternetProvider_en_NZ-clone)
...
#> Warning:  CompanyProvider does not have locale en_NZ, defaulting to en_US locale.
#> Warning:  LoremProvider does not have locale en_NZ, defaulting to en_US locale.
x$email()
#> [1] "kathryn.rowe@marvin.geek.nz"
x$free_email()
#> [1] "charlie.casey@inspire.net.nz"
x$mac_address()
#> [1] "f7:99:59:ee:8a:73:d9"
x$company_email()
#> [1] "hhenderson@plc.net.nz"
```
