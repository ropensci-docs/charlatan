...
- [`InternetProvider_bg_BG$clone()`](#method-InternetProvider_bg_BG-clone)
...
#> Warning:  LoremProvider does not have locale bg_BG, defaulting to en_US locale.
x$email()
#> [1] ".@NA.edu"
x$free_email()
#> [1] ".@abv.bg"
x$mac_address()
#> [1] "e4:35:74:9d:7f:b6:36"
x$company_email()
#> [1] "@кда.edu"
```
