...
- [`InternetProvider_hr_HR$clone()`](#method-InternetProvider_hr_HR-clone)
...
x$email()
#> [1] "suzana95@gmail.com"
x$free_email()
#> [1] "buric.slavica@gmail.com"
x$mac_address()
#> [1] "20:40:ed:c3:ad:38:cf"
x$company_email()
#> [1] "fmikulcic@barbic.net"
```
